...
import type { RouteCandidate } from '../types/safero';
import { formatDistance, formatDuration } from '../utils/safero';
...
export function RouteCard({ route, onSelect }: RouteCardProps) {
  ...
  return (
    <motion.button
      ...
      className={[
      'relative w-full overflow-hidden rounded-card border p-[18px] text-left',
      ...
      <span
        aria-hidden="true"
        className="pointer-events-none absolute inset-0 bg-grad-navy-soft" /> :
