...
interface CurrentLocationMarkerProps {
  /** Position inside the map area, in percentages. */
  x?: number;
  y?: number;
  /** 'dot' = overhead blue dot, 'puck' = driving direction arrow. */
  variant?: 'dot' | 'puck';
}
  ...
  return (
    <div
      ...
      <div className="relative flex items-center justify-center">
        ...
        <span
          className="absolute h-10 w-10 rounded-full bg-navy opacity-[0.07] blur-md" />
