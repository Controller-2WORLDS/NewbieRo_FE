    ...
    <div className="relative flex h-full min-h-0 flex-col">
      <MapPlaceholder
        ...
        <MapMarker
          ...
          x={44}
          y={38}
          label={`위험구간 ${riskSegments[0].road_name}`} />
      ...
      <div className="relative z-20 flex h-full min-h-0 flex-col p-4">
        <div className="flex items-start gap-3">
          ...
          <button
            ...
            aria-label="주행 종료"
            className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full border border-line-soft bg-grad-sheen text-ink shadow-lifted-inset backdrop-blur-xl transition-transform duration-150 ease-out active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-navy">
          ...
          <AnimatePresence>
            ...
            <motion.div
              ...
              className="flex items-center gap-2.5 rounded-btn border border-line-soft bg-grad-sheen py-2.5 pl-3 pr-2.5 shadow-lifted-inset backdrop-blur-xl">
                ...
                <CongestionBadge
                rate={approachingRestArea.predicted_occupancy_rate} />
