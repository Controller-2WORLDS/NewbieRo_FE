...
import type { DriverType } from '../types/safero';
  ...
  return (
    <div className="relative h-full min-h-0">
      <MapPlaceholder
        ...
        {destination ?
        <MapMarker kind="place" x={64} y={34} label={destination} /> :
        null}
      </MapPlaceholder>
      ...
      <div className="absolute inset-x-0 top-0 z-20 px-4 pt-3">
        <button
          ...
          className="flex h-[54px] w-full items-center gap-2.5 rounded-btn border border-line-soft bg-grad-sheen px-4 shadow-lifted-inset backdrop-blur-xl transition-transform duration-150 ease-out active:scale-[0.99] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-navy">
          
          <NavigationIcon
            className="h-[18px] w-[18px] shrink-0 text-navy"
            strokeWidth={2.2}
            aria-hidden="true" />
      ...
      <div className="absolute bottom-5 right-4 z-20">
        <button
          ...
          className="flex h-12 w-12 items-center justify-center rounded-full border border-line-soft bg-grad-sheen text-navy shadow-lifted-inset backdrop-blur-xl transition-transform duration-150 ease-out active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-navy">
        ...
        <div className="px-5 pb-7 pt-3">
          ...
          <div className="mt-5">
            <Input
              ...
              icon={
              <NavigationIcon className="h-[18px] w-[18px]" strokeWidth={2} />
              }
              placeholder="현재 위치" />
          ...
          <div className="mt-5">
            <p className="mb-2.5 text-[13px] font-medium text-ink-2">
              운전자 유형
            </p>
            <SegmentedControl
              label="운전자 유형"
