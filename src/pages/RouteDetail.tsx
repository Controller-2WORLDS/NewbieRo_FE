...
export function RouteDetail() {
  ...
  const [activeRoad, setActiveRoad] = React.useState<string | null>(
    riskSegments[0].road_name
  );
      ...
      <div className="min-h-0 flex-1 overflow-y-auto no-scrollbar">
        <InteractiveMap
          ...
          <MapMarker
            ...
            onClick={() =>
            setActiveRoad((current) =>
            current === segment.road_name ? null : segment.road_name
            )
            }>
          ...
          <section>
            ...
            <Card className="mt-3 !py-1 shadow-card">
              <SeverityChart
                ...
                onSelect={(road_name) =>
                setActiveRoad((current) =>
                current === road_name ? null : road_name
                )
                } />
            ...
            <ul className="mt-1 divide-y divide-line">
              ...
              <li
                ...
                className="flex items-center justify-between gap-3 py-3.5">
                  ...
                  <CongestionBadge
                  rate={restArea.predicted_occupancy_rate}
                  size="sm" />
